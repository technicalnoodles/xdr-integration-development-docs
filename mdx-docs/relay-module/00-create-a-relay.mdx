...
:::note
This is a quick way get an integration connected to Cisco XDR for development. But it will not have eveything that can be done with a relay module. As an example, if your product is able to provide value to the XDR Dashboard area, then we will need to create a **module type** that enables the _tile_ functionality.
:::
